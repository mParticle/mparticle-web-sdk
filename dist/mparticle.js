var mParticle = (function () {
    ...
    ***************************************************************************** */
    ...
    function didUserChange(previousUser, newUser) {
    ...
    function Identity(mpInstance) {
      ...
      this.parseIdentityResponse = function (xhr, previousMPID, callback, identityApiData, method, knownIdentities, parsingCachedResponse) {
        ...
        try {
          ...
          var mpidIsNotInCookies = !mpInstance._Persistence.getFirstSeenTime(identityApiResult.mpid);
          ...
          if (xhr.status === 200) {
            ...
            var uiByName = method === Modify$1 ? previousUIByName : incomingMpidUIByName;
            self.sendUserIdentityChangeEvent(newIdentitiesByName, identityApiResult.mpid, uiByName);
          }
          if (callback) {
      ...
      this.sendUserIdentityChangeEvent = function (newUserIdentities, mpid, currentUserIdentities) {
        // https://go.mparticle.com/work/SQDSDKS-6354
        ...
        for (var identityType in newUserIdentities) {
          ...
          if (currentUserIdentities[identityType] !== newUserIdentities[identityType]) {
            ...
            var isNewUserIdentityType = !currentUserIdentities[identityType];
            var userIdentityChangeEvent = self.createUserIdentityChange(identityType, newUserIdentities[identityType], currentUserIdentities[identityType], isNewUserIdentityType, currentUserInMemory);
