declare const Constants: {
    ...
    readonly Messages: {
        readonly DeprecationMessages: {
            readonly MethodHasBeenDeprecated: "has been deprecated.";
            readonly MethodMarkedForDeprecationPostfix: "is a deprecated method and will be removed in future releases.";
            readonly AlternativeMethodPrefix: "Please use the alternate method:";
        };
        readonly ErrorMessages: {
            ...
            readonly AudienceAPINotEnabled: "Your workspace is not enabled to retrieve user audiences.";
        };
    ...
    readonly DefaultBaseUrls: {
        ...
        readonly userAudienceUrl: "nativesdks.mparticle.com/v1/";
    };
    readonly CNAMEUrlPaths: {
        readonly v1SecureServiceUrl: "/webevents/v1/JS/";
        readonly v2SecureServiceUrl: "/webevents/v2/JS/";
        readonly v3SecureServiceUrl: "/webevents/v3/JS/";
        readonly configUrl: "/tags/JS/v2/";
        readonly identityUrl: "/identity/v1/";
        readonly aliasUrl: "/webevents/v1/identity/";
    };
    ...
    readonly FeatureFlags: {
        ...
        readonly OfflineStorage: "offlineStorage";
        readonly DirectUrlRouting: "directURLRouting";
    ...
    readonly CaptureIntegrationSpecificIdsV2Modes: {
        readonly All: "all";
        readonly None: "none";
        readonly RoktOnly: "roktonly";
    };
    readonly Rokt: {
        readonly LauncherInstanceGuidKey: "__rokt_li_guid__";
    };
};
