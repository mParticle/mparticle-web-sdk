...
declare global {
    interface Window {
        webkit?: {
            messageHandlers?: Record<string, IWKScriptMessageHandler | undefined>;
        };
...
export interface INativeSdkHelpers {
    ...
    isWebviewEnabled: (requiredWebviewBridgeName: string, minWebviewBridgeVersion: number) => boolean;
