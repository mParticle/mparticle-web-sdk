...
declare const toWebSafeBase64: (value: string) => string | undefined;
...
declare const hasOwnProp: (obj: object, key: PropertyKey) => boolean;
declare const isReservedStoredPropertyName: (name: string) => boolean;
...
declare const getErrorMessage: (e: unknown, fallback?: string) => string;
export { createCookieString, revertCookieString, createCookieSyncUrl, toWebSafeBase64, valueof, AttributeValue, converted, decoded, obfuscateDevData, filterDictionaryWithHash, findKeyInObject, generateDeprecationMessage, generateHash, generateUniqueId, getErrorMessage, getRampNumber, inArray, isObject, isStringOrNumber, obfuscateData, parseConfig, parseNumber, parseSettingsString, parseStringOrNumber, replaceCommasWithPipes, replacePipesWithCommas, replaceApostrophesWithQuotes, replaceQuotesWithApostrophes, returnConvertedBoolean, toDataPlanSlug, isString, isNumber, isFunction, isDataPlanSlug, isEmpty, isValidAttributeValue, isValidCustomFlagProperty, mergeObjects, moveElementToEnd, queryStringParser, hasOwnProp, isReservedStoredPropertyName, getCookies, getHref, replaceMPID, replaceAmpWithAmpersand, extend, };
