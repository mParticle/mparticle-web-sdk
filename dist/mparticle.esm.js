...
var Messages$5=Constants.Messages,sendEventToServer$1=ApiClient.sendEventToServer;function logEvent(a){if(mParticle.Logger.verbose(Messages$5.InformationMessages.StartingLogEvent+": "+a.name),Helpers.canLog()){a.data&&(a.data=Helpers.sanitizeAttributes(a.data));var b=ServerModel.createEventObject(a);sendEventToServer$1(b);}else mParticle.Logger.verbose(Messages$5.InformationMessages.AbandonLogEvent);}function startTracking(a){function b(b){// prevents callback from being fired multiple times
...
return !b&&window.mParticle.config&&(window.console.warn("You did not pass a config object to mParticle.init(). Attempting to use the window.mParticle.config if it exists. Please note that in a future release, this may not work and mParticle will not initialize properly"),b=window.mParticle.config),runPreConfigFetchInitialization(a,b),b?void(!b.hasOwnProperty("requestConfig")||b.requestConfig?ApiClient.getSDKConfiguration(a,b,completeSDKInitialization):completeSDKInitialization(a,b)):void window.console.error("No config available on the window, please pass a config object to mParticle.init()")},setLogLevel:function setLogLevel(a){mParticle$1.Logger.setLogLevel(a);},/**
     ...
     */stopTrackingLocation:function stopTrackingLocation(){Events.stopTracking();},/**
     ...
     */startTrackingLocation:function startTrackingLocation(a){Validators$4.isFunction(a)||mParticle$1.Logger.warning("Warning: Location tracking is triggered, but not including a callback into the `startTrackingLocation` may result in events logged too quickly and not being associated with a location."),Events.startTracking(a);},/**
     * Sets the position of the user
     * @method setPosition
     * @param {Number} lattitude lattitude digit
     * @param {Number} longitude longitude digit
     */setPosition:function setPosition(a,b){"number"==typeof a&&"number"==typeof b?mParticle$1.Store.currentPosition={lat:a,lng:b}:mParticle$1.Logger.error("Position latitude and/or longitude must both be of type number");},/**
...
SessionManager.endSession(!0);},/**
     ...
     */logBaseEvent:function logBaseEvent(a){return mParticle$1.Store.isInitialized?(SessionManager.resetSessionTimer(),"string"!=typeof a.name)?void mParticle$1.Logger.error(Messages$8.ErrorMessages.EventNameInvalidType):(a.eventType||(a.eventType=Types.EventType.Unknown),Helpers.canLog()?void Events.logEvent(a):void mParticle$1.Logger.error(Messages$8.ErrorMessages.LoggingDisabled)):void mParticle$1.ready(function(){mParticle$1.logBaseEvent(a);})},/**
     ...
     */logError:function logError(a,b){if(!mParticle$1.Store.isInitialized)return void mParticle$1.ready(function(){mParticle$1.logError(a,b);});if(SessionManager.resetSessionTimer(),!!a){"string"==typeof a&&(a={message:a});var c={m:a.message?a.message:a,s:"Error",t:a.stack};if(b){var d=Helpers.sanitizeAttributes(b);for(var e in d)c[e]=d[e];}Events.logEvent({messageType:Types.MessageType.CrashReport,name:a.name?a.name:"Error",data:c,eventType:Types.EventType.Other});}},/**
     * Logs `click` events
     * @method logLink
     ...
     * @param {Object} [eventInfo] Attributes for the event
     */logLink:function logLink(a,b,c,d){Events.addEventHandler("click",a,b,d,c);},/**
     * Logs `submit` events
     * @method logForm
     ...
     * @param {Number} [eventType] The eventType as seen [here](http://docs.mparticle.com/developers/sdk/javascript/event-tracking#event-type)
     * @param {Object} [eventInfo] Attributes for the event
     */logForm:function logForm(a,b,c,d){Events.addEventHandler("submit",a,b,d,c);},/**
     * Logs a page view
     * @method logPageView
     * @param {String} eventName The name of the event. Defaults to 'PageView'.
     * @param {Object} [attrs] Attributes for the event
     * @param {Object} [customFlags] Custom flags for the event
     */logPageView:function logPageView(a,b,c){if(!mParticle$1.Store.isInitialized)return void mParticle$1.ready(function(){mParticle$1.logPageView(a,b,c);});if(SessionManager.resetSessionTimer(),Helpers.canLog()){if(Validators$4.isStringOrNumber(a)||(a="PageView"),!b)b={hostname:window.location.hostname,title:window.document.title};else if(!Helpers.isObject(b))return void mParticle$1.Logger.error("The attributes argument must be an object. A "+_typeof_1(b)+" was entered. Please correct and retry.");if(c&&!Helpers.isObject(c))return void mParticle$1.Logger.error("The customFlags argument must be an object. A "+_typeof_1(c)+" was entered. Please correct and retry.")}Events.logEvent({messageType:Types.MessageType.PageView,name:a,data:b,eventType:Types.EventType.Unknown,customFlags:c});},Consent:{createGDPRConsent:Consent.createGDPRConsent,createConsentState:Consent.createConsentState},/**
     ...
     */eCommerce:{/**
         ...
         */Cart:{/**
             ...
             * @deprecated
             */add:function add(a,b){mParticle$1.Logger.warning("Deprecated function eCommerce.Cart.add() will be removed in future releases");var c,d=mParticle$1.Identity.getCurrentUser();d&&(c=d.getMPID()),mParticleUserCart$1(c).add(a,b);},/**
             * Removes a product from the cart
             * @method remove
             * @param {Object} product The product you want to add to the cart
             * @param {Boolean} [logEventBoolean] Option to log the event to mParticle's servers. If blank, no logging occurs.
             * @deprecated
             */remove:function remove(a,b){mParticle$1.Logger.warning("Deprecated function eCommerce.Cart.remove() will be removed in future releases");var c,d=mParticle$1.Identity.getCurrentUser();d&&(c=d.getMPID()),mParticleUserCart$1(c).remove(a,b);},/**
             * Clears the cart
             * @method clear
             * @deprecated
             */clear:function clear(){mParticle$1.Logger.warning("Deprecated function eCommerce.Cart.clear() will be removed in future releases");var a,b=mParticle$1.Identity.getCurrentUser();b&&(a=b.getMPID()),mParticleUserCart$1(a).clear();}},/**
         * Sets the currency code
         * @for mParticle.eCommerce
         * @method setCurrencyCode
         * @param {String} code The currency code
         */setCurrencyCode:function setCurrencyCode(a){return mParticle$1.Store.isInitialized?"string"==typeof a?void(SessionManager.resetSessionTimer(),mParticle$1.Store.currencyCode=a):void mParticle$1.Logger.error("Code must be a string"):void mParticle$1.ready(function(){mParticle$1.eCommerce.setCurrencyCode(a);})},/**
         * Creates a product
         * @for mParticle.eCommerce
         ...
         */createProduct:function createProduct(a,b,c,d,e,f,g,h,i,j){return Ecommerce.createProduct(a,b,c,d,e,f,g,h,i,j)},/**
         * Creates a promotion
         * @for mParticle.eCommerce
         ...
         */createPromotion:function createPromotion(a,b,c,d){return Ecommerce.createPromotion(a,b,c,d)},/**
         * Creates a product impression
         * @for mParticle.eCommerce
         * @method createImpression
         * @param {String} name impression name
         * @param {Object} product the product for which an impression is being created
         */createImpression:function createImpression(a,b){return Ecommerce.createImpression(a,b)},/**
         ...
         */createTransactionAttributes:function createTransactionAttributes(a,b,c,d,e,f){return Ecommerce.createTransactionAttributes(a,b,c,d,e,f)},/**
         ...
         * @param {Object} attrs
         * @param {Object} [customFlags] Custom flags for the event
         */logCheckout:function logCheckout(a,b,c,d){return mParticle$1.Store.isInitialized?void(SessionManager.resetSessionTimer(),Events.logCheckoutEvent(a,b,c,d)):void mParticle$1.ready(function(){mParticle$1.eCommerce.logCheckout(a,b,c,d);})},/**
         ...
         * @param {Object} [customFlags] Custom flags for the event
         */logProductAction:function logProductAction(a,b,c,d){return mParticle$1.Store.isInitialized?void(SessionManager.resetSessionTimer(),Events.logProductActionEvent(a,b,c,d)):void mParticle$1.ready(function(){mParticle$1.eCommerce.logProductAction(a,b,c,d);})},/**
         ...
         * @param {Object} [customFlags] Custom flags for the event
         */logPurchase:function logPurchase(a,b,c,d,e){return mParticle$1.Store.isInitialized?a&&b?void(SessionManager.resetSessionTimer(),Events.logPurchaseEvent(a,b,d,e),!0===c&&mParticle$1.eCommerce.Cart.clear()):void mParticle$1.Logger.error(Messages$8.ErrorMessages.BadLogPurchase):void mParticle$1.ready(function(){mParticle$1.eCommerce.logPurchase(a,b,c,d,e);})},/**
         ...
         * @param {Object} [customFlags] Custom flags for the event
         */logPromotion:function logPromotion(a,b,c,d){return mParticle$1.Store.isInitialized?void(SessionManager.resetSessionTimer(),Events.logPromotionEvent(a,b,c,d)):void mParticle$1.ready(function(){mParticle$1.eCommerce.logPromotion(a,b,c,d);})},/**
         ...
         * @param {Object} [customFlags] Custom flags for the event
         */logImpression:function logImpression(a,b,c){return mParticle$1.Store.isInitialized?void(SessionManager.resetSessionTimer(),Events.logImpressionEvent(a,b,c)):void mParticle$1.ready(function(){mParticle$1.eCommerce.logImpression(a,b,c);})},/**
         * Logs a refund
         * @for mParticle.eCommerce
         * @method logRefund
         ...
         * @param {Object} [customFlags] Custom flags for the event
         */logRefund:function logRefund(a,b,c,d,e){return mParticle$1.Store.isInitialized?void(SessionManager.resetSessionTimer(),Events.logRefundEvent(a,b,d,e),!0===c&&mParticle$1.eCommerce.Cart.clear()):void mParticle$1.ready(function(){mParticle$1.eCommerce.logRefund(a,b,c,d,e);})},expandCommerceEvent:function expandCommerceEvent(a){return Ecommerce.expandCommerceEvent(a)}},/**
...
if(!mParticle$1.Store.isInitialized)return void mParticle$1.ready(function(){mParticle$1.setSessionAttribute(a,b);});if(Helpers.canLog()){if(!Validators$4.isValidAttributeValue(b))return void mParticle$1.Logger.error(Messages$8.ErrorMessages.BadAttribute);if(!Validators$4.isValidKeyValue(a))return void mParticle$1.Logger.error(Messages$8.ErrorMessages.BadKey);if(mParticle$1.Store.webviewBridgeEnabled)NativeSdkHelpers.sendToNative(Constants.NativeSdkPaths.SetSessionAttribute,JSON.stringify({key:a,value:b}));else{var c=Helpers.findKeyInObject(mParticle$1.Store.sessionAttributes,a);c&&(a=c),mParticle$1.Store.sessionAttributes[a]=b,Persistence.update(),Forwarders.applyToForwarders("setSessionAttribute",[a,b]);}}},/**
     ...
     */setIntegrationAttribute:function setIntegrationAttribute(a,b){if(!mParticle$1.Store.isInitialized)return void mParticle$1.ready(function(){mParticle$1.setIntegrationAttribute(a,b);});if("number"!=typeof a)return void mParticle$1.Logger.error("integrationId must be a number");if(null===b)mParticle$1.Store.integrationAttributes[a]={};else{if(!Helpers.isObject(b))return void mParticle$1.Logger.error("Attrs must be an object with keys and values. You entered a "+_typeof_1(b));if(0===Object.keys(b).length)mParticle$1.Store.integrationAttributes[a]={};else for(var c in b)if("string"!=typeof c){mParticle$1.Logger.error("Keys must be strings, you entered a "+_typeof_1(c));continue}else if("string"==typeof b[c])Helpers.isObject(mParticle$1.Store.integrationAttributes[a])?mParticle$1.Store.integrationAttributes[a][c]=b[c]:(mParticle$1.Store.integrationAttributes[a]={},mParticle$1.Store.integrationAttributes[a][c]=b[c]);else{mParticle$1.Logger.error("Values for integration attributes must be strings. You entered a "+_typeof_1(b[c]));continue}}Persistence.update();},/**
     ...
     */getIntegrationAttributes:function getIntegrationAttributes(a){return mParticle$1.Store.integrationAttributes[a]?mParticle$1.Store.integrationAttributes[a]:{}},addForwarder:function addForwarder(a){mParticle$1.preInit.forwarderConstructors.push(a);},configurePixel:function configurePixel(a){Forwarders.configurePixel(a);},_getActiveForwarders:function _getActiveForwarders(){return mParticle$1.Store.activeForwarders},_getIntegrationDelays:function _getIntegrationDelays(){return mParticle$1.preInit.integrationDelays},_setIntegrationDelay:function _setIntegrationDelay(a,b){mParticle$1.preInit.integrationDelays[a]=b;}};function completeSDKInitialization(a,b){if(mParticle$1.Store.storageName=Helpers.createMainStorageName(b.workspaceToken),mParticle$1.Store.prodStorageName=Helpers.createProductStorageName(b.workspaceToken),b.hasOwnProperty("workspaceToken")?mParticle$1.Store.SDKConfig.workspaceToken=b.workspaceToken:mParticle$1.Logger.warning("You should have a workspaceToken on your mParticle.config object for security purposes."),b.hasOwnProperty("requiredWebviewBridgeName")?mParticle$1.Store.SDKConfig.requiredWebviewBridgeName=b.requiredWebviewBridgeName:b.hasOwnProperty("workspaceToken")&&(mParticle$1.Store.SDKConfig.requiredWebviewBridgeName=b.workspaceToken),mParticle$1.Store.webviewBridgeEnabled=NativeSdkHelpers.isWebviewEnabled(mParticle$1.Store.SDKConfig.requiredWebviewBridgeName,mParticle$1.Store.SDKConfig.minWebviewBridgeVersion),mParticle$1.Store.configurationLoaded=!0,mParticle$1.Store.webviewBridgeEnabled||(Migrations.migrate(),Persistence.initializeStorage()),mParticle$1.Store.webviewBridgeEnabled)NativeSdkHelpers.sendToNative(Constants.NativeSdkPaths.SetSessionAttribute,JSON.stringify({key:"$src_env",value:"webview"})),a&&NativeSdkHelpers.sendToNative(Constants.NativeSdkPaths.SetSessionAttribute,JSON.stringify({key:"$src_key",value:a}));else{var c;// If no initialIdentityRequest is passed in, we set the user identities to what is currently in cookies for the identify request
