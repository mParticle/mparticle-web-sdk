...
return a._Helpers.getFeatureFlag(FeatureFlags$1.AudienceAPI)?void(null===d.audienceManager&&(d.audienceManager=new AudienceManager(a._Store.SDKConfig.userAudienceUrl,a._Store.devToken,a.Logger,b)),d.audienceManager.sendGetUserAudienceRequest(b,c)):void a.Logger.error(ErrorMessages.AudienceAPINotEnabled)}}},this.mParticleUserCart=function(){return {/**
             ...
             * @deprecated
             */getCartProducts:function getCartProducts(){return a.Logger.warning(generateDeprecationMessage("Identity.getCurrentUser().getCart().getCartProducts()",!0,"eCommerce.logProductAction()","https://docs.mparticle.com/developers/sdk/web/commerce-tracking")),[]}}},this.parseIdentityResponse=function(b,d,f,g,h,i,j){var k,l,m,n,o=a.Identity.getUser(d),p=o?o.getMPID():null,q=o?o.getUserIdentities().userIdentities:{},r={};a._Store.identityCallInFlight=!1;try{var s,t,u;if(a.Logger.verbose("Parsing \""+h+"\" identity response from server"),m=null!==(s=b.responseText)&&void 0!==s?s:null,a._Store.isLoggedIn=(null===(t=m)||void 0===t?void 0:t.is_logged_in)||!1,hasMPIDChanged(o,m)&&(a._Store.mpid=m.mpid,o&&a._Persistence.setLastSeenTime(d),l=!a._Persistence.getFirstSeenTime(m.mpid),a._Persistence.setFirstSeenTime(m.mpid)),b.status===HTTP_OK){c(CacheIdentity)&&cacheOrClearIdCache(h,i,e.idCache,b,j);var v=e.IdentityAPI.getUser(m.mpid),w=v?v.getUserIdentities().userIdentities:{};h===Modify$1?(r=a._Identity.IdentityRequest.combineUserIdentities(q,g.userIdentities),a._Store.setUserIdentities(d,r)):(h===Identify&&o&&m.mpid===p&&a._Persistence.setFirstSeenTime(m.mpid),a._Store.addMpidToSessionHistory(m.mpid,d),a._CookieSyncManager.attemptCookieSync(m.mpid,l),a._Persistence.swapCurrentUser(d,m.mpid,a._Store.currentSessionMPIDs),g&&!isEmpty(g.userIdentities)&&(r=e.IdentityRequest.combineUserIdentities(w,g.userIdentities)),a._Store.setUserIdentities(m.mpid,r),a._Persistence.update(),a._Store.syncPersistenceData(),a._Persistence.findPrevCookiesBasedOnUI(g),a._Store.context=m.context||a._Store.context),n=a.Identity.getCurrentUser(),tryOnUserAlias(o,n,g,a.Logger);var x=a._Persistence.getPersistence();n&&(a._Persistence.storeDataInMemory(x,n.getMPID()),e.reinitForwardersOnUserChange(o,n),e.setForwarderCallbacks(n,h));var y=IdentityType.getNewIdentitiesByName(r),z=h===Modify$1?q:w;// https://go.mparticle.com/work/SQDSDKS-6501
e.sendUserIdentityChangeEvent(y,h,m.mpid,z);}if(f){var A=0===b.status?HTTPCodes$2.noHttpCoverage:b.status;a._Helpers.invokeCallback(f,A,m||null,n);}else m&&!isEmpty(m.errors)&&// https://go.mparticle.com/work/SQDSDKS-6500
a.Logger.error("Received HTTP response code of "+b.status+" - "+m.errors[0].message);a.Logger.verbose("Successfully parsed Identity Response"),null===(u=a._APIClient)||void 0===u||u.processQueuedEvents();}catch(c){f&&a._Helpers.invokeCallback(f,b.status,m||null),a.Logger.error("Error parsing JSON response from Identity server: "+c);}a._Store.isInitialized=!0,a._RoktManager.onIdentityComplete(),a._preInit.readyQueue=processReadyQueue(a._preInit.readyQueue);var B=null===(k=a._CookieConsentManager)||void 0===k?void 0:k.getNoTargeting();n&&B?n.setUserAttribute("$NoTargeting",B):n&&n.removeUserAttribute("$NoTargeting");},this.sendUserIdentityChangeEvent=function(b,c,d,f){if(d||c===Modify$1)// https://go.mparticle.com/work/SQDSDKS-6501
{// https://go.mparticle.com/work/SQDSDKS-6354
