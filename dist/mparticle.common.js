...
var h=c||Date.now();return "fb.".concat(g,".").concat(h,".").concat(a)};var integrationMapping={// Facebook / Meta
fbclid:{mappedKey:"Facebook.ClickId",processor:facebookClickIdProcessor},_fbp:{mappedKey:"Facebook.BrowserId"},_fbc:{mappedKey:"Facebook.ClickId"},// Google
gclid:{mappedKey:"GoogleEnhancedConversions.Gclid"},gbraid:{mappedKey:"GoogleEnhancedConversions.Gbraid"},wbraid:{mappedKey:"GoogleEnhancedConversions.Wbraid"}},IntegrationCapture=/** @class */function(){function a(){this.initialTimestamp=Date.now();}/**
