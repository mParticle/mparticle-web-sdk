...
var HTTP_OK=200;var HTTP_ACCEPTED=202;var HTTP_BAD_REQUEST=400;var HTTP_SERVER_ERROR=500;
...
getExpansionName:function getExpansionName(a){return a===PromotionActionType.PromotionView?"view":a===PromotionActionType.PromotionClick?"click":"unknown"}};var ProfileMessageType={Logout:3};var ApplicationTransitionType$1={AppInit:1};var PerformanceMarkType={SdkStart:"mp:sdkStart",JointSdkSelectPlacements:"mp:jointSdkSelectPlacements",JointSdkRoktKitInit:"mp:jointSdkRoktKitInit"};function getMessageTypeFromEventType(a){return "custom_event"===a?MessageType$1.PageEvent:"screen_view"===a?MessageType$1.PageView:"commerce_event"===a?MessageType$1.Commerce:"session_start"===a?MessageType$1.SessionStart:"session_end"===a?MessageType$1.SessionEnd:"crash_report"===a?MessageType$1.CrashReport:"opt_out"===a?MessageType$1.OptOut:"application_state_transition"===a?MessageType$1.AppStateTransition:"user_attribute_change"===a?MessageType$1.UserAttributeChange:"user_identity_change"===a?MessageType$1.UserIdentityChange:-1}function getEventCategoryFromCustomEventType(a){return "navigation"===a?EventType.Navigation:"location"===a?EventType.Location:"search"===a?EventType.Search:"transaction"===a?EventType.Transaction:"user_content"===a?EventType.UserContent:"user_preference"===a?EventType.UserPreference:"social"===a?EventType.Social:"other"===a?EventType.Other:"media"===a?EventType.Media:"add_to_cart"===a?CommerceEventType.ProductAddToCart:"remove_from_cart"===a?CommerceEventType.ProductRemoveFromCart:"checkout"===a?CommerceEventType.ProductCheckout:"checkout_option"===a?CommerceEventType.ProductCheckoutOption:"click"===a?CommerceEventType.ProductClick:"view_detail"===a?CommerceEventType.ProductViewDetail:"purchase"===a?CommerceEventType.ProductPurchase:"refund"===a?CommerceEventType.ProductRefund:"promotion_view"===a?CommerceEventType.PromotionView:"promotion_click"===a?CommerceEventType.PromotionClick:"add_to_wishlist"===a?CommerceEventType.ProductAddToWishlist:"remove_from_wishlist"===a||"remove_from_wish_list"===a?CommerceEventType.ProductRemoveFromWishlist:"impression"===a?CommerceEventType.ProductImpression:EventType.Unknown}function getIdentityTypeFromBatchKey(a){return "other"===a?IdentityType.Other:"customer_id"===a?IdentityType.CustomerId:"facebook"===a?IdentityType.Facebook:"twitter"===a?IdentityType.Twitter:"google"===a?IdentityType.Google:"microsoft"===a?IdentityType.Microsoft:"yahoo"===a?IdentityType.Yahoo:"email"===a?IdentityType.Email:"facebook_custom_audience_id"===a?IdentityType.FacebookCustomAudienceId:"other_id_2"===a?IdentityType.Other2:"other_id_3"===a?IdentityType.Other3:"other_id_4"===a?IdentityType.Other4:"other_id_5"===a?IdentityType.Other5:"other_id_6"===a?IdentityType.Other6:"other_id_7"===a?IdentityType.Other7:"other_id_8"===a?IdentityType.Other8:"other_id_9"===a?IdentityType.Other9:"other_id_10"===a?IdentityType.Other10:"mobile_number"===a?IdentityType.MobileNumber:"phone_number_2"===a?IdentityType.PhoneNumber2:"phone_number_3"===a?IdentityType.PhoneNumber3:-1}var Types = {MessageType:MessageType$1,EventType:EventType,CommerceEventType:CommerceEventType,IdentityType:IdentityType,ProfileMessageType:ProfileMessageType,ApplicationTransitionType:ApplicationTransitionType$1,ProductActionType:ProductActionType,PromotionActionType:PromotionActionType,Environment:Constants.Environment};
...
var BaseVault=/** @class */function(){/**
     ...
     */return a.prototype.store=function(a){var b;this.contents=a,b=isNumber(a)||!isEmpty(a)?JSON.stringify(a):"",this.storageObject.setItem(this._storageKey,b);},a.prototype.retrieve=function(){// TODO: Handle cases where Local Storage is unavailable
// https://go.mparticle.com/work/SQDSDKS-5022
var a=this.storageObject.getItem(this._storageKey);return this.contents=a?JSON.parse(a):null,this.contents},a.prototype.purge=function(){this.contents=null,this.storageObject.removeItem(this._storageKey);},a}();var LocalStorageVault=/** @class */function(a){function b(b){return a.call(this,b,window.localStorage)||this}return __extends(b,a),b}(BaseVault);var SessionStorageVault=/** @class */function(a){function b(b){return a.call(this,b,window.sessionStorage)||this}return __extends(b,a),b}(BaseVault);var DisabledVault=/** @class */function(a){function b(b){var c=a.call(this,b,window.localStorage)||this;return c.contents=null,c.storageObject.removeItem(c._storageKey),c}return __extends(b,a),b.prototype.store=function(){this.contents=null;},b.prototype.retrieve=function(){return this.contents},b.prototype.purge=function(){this.contents=null;},b}(BaseVault);
 ...
 */var BatchUploader=/** @class */function(){/**
     ...
     */function a(b,c){var d,e;this.offlineStorageEnabled=!1,this.lastASTEventTime=0,this.AST_DEBOUNCE_MS=1e3,this.uploadIntervalTimerId=null,this.exitHandler=null,this.visibilityChangeHandler=null,this.destroyed=!1,this.mpInstance=b,this.uploadIntervalMillis=c,this.batchingEnabled=c>=a.MINIMUM_INTERVAL_MILLIS,this.uploadIntervalMillis<a.MINIMUM_INTERVAL_MILLIS&&(this.uploadIntervalMillis=a.MINIMUM_INTERVAL_MILLIS),this.eventsQueuedForProcessing=[],this.batchesQueuedForProcessing=[],this.offlineStorageEnabled=this.isOfflineStorageAvailable();// When noFunctional is true, prevent events/batches storage
var f=null===(e=b._CookieConsentManager)||void 0===e?void 0:e.getNoFunctional();this.offlineStorageEnabled&&!f&&(this.eventVault=new SessionStorageVault("".concat(b._Store.storageName,"-events")),this.batchVault=new LocalStorageVault("".concat(b._Store.storageName,"-batches")),(d=this.eventsQueuedForProcessing).push.apply(d,this.eventVault.retrieve()));var g=this.mpInstance._Store,h=g.SDKConfig,i=g.devToken,j=this.mpInstance._Helpers.createServiceUrl(h.v3SecureServiceUrl,i);this.uploadUrl="".concat(j,"/events"),this.uploader=window.fetch?new FetchUploader(this.uploadUrl):new XHRUploader(this.uploadUrl),this.triggerUploadInterval(!0,!1),this.addEventListeners();}/**
...
//       https://go.mparticle.com/work/SQDSDKS-5022
return e>=f},a.prototype.shouldDebounceAndUpdateLastASTTime=function(){var a=Date.now();return !!(a-this.lastASTEventTime<this.AST_DEBOUNCE_MS)||(this.lastASTEventTime=a,!1)},a.prototype.createBackgroundASTEvent=function(){var a=Date.now(),b=this.mpInstance,c=b._Store,d=b.Identity,e=b._timeOnSiteTimer,f=b._Helpers,g=c.sessionId,h=c.deviceId,i=c.sessionStartDate,j=c.SDKConfig,k=f.generateUniqueId,l=f.getFeatureFlag,m=d.getCurrentUser,n={AppName:j.appName,AppVersion:j.appVersion,Package:j["package"],EventDataType:MessageType$1.AppStateTransition,Timestamp:a,SessionId:g,DeviceId:h,IsFirstRun:!1,SourceMessageId:k(),SDKVersion:Constants.sdkVersion,CustomFlags:{},EventAttributes:{},SessionStartDate:(null===i||void 0===i?void 0:i.getTime())||a,Debug:j.isDevelopmentMode,ActiveTimeOnSite:(null===e||void 0===e?void 0:e.getTimeInForeground())||0,IsBackgroundAST:!0},o=__assign({},n.CustomFlags),p=c.integrationAttributes,q=l(Constants.FeatureFlags.CaptureIntegrationSpecificIds),r=l(Constants.FeatureFlags.CaptureIntegrationSpecificIdsV2)||"",s=r&&r!==Constants.CaptureIntegrationSpecificIdsV2Modes.None||!0===q;// https://go.mparticle.com/work/SQDSDKS-5053
...
var _a=Constants.IdentityMethods,Identify$2=_a.Identify,Modify$4=_a.Modify,Login$2=_a.Login,Logout$2=_a.Logout;var CACHE_HEADER="x-mp-max-age";var cacheOrClearIdCache=function(a,b,c,d,e){// when parsing a response that has already been cached, simply return instead of attempting another cache
...
if(h){var i=getCachedIdentity(g,a,b);return c(i,d,e,f,g,a,!0),!0}return !1};var getExpireTimestamp=function(a){return void 0===a&&(a=ONE_DAY_IN_SECONDS),new Date().getTime()+a*MILLIS_IN_ONE_SEC},parseIdentityResponse=function(a){return a?JSON.parse(a):{}};var hasIdentityRequestChanged=function(a,b){if(!a||!(null!==b&&void 0!==b)||!b.userIdentities)return !1;var c=a.getUserIdentities().userIdentities,d=b.userIdentities;return JSON.stringify(c)!==JSON.stringify(d)};/**
...
var Modify$3=Constants.IdentityMethods.Modify,Validators={// From ./utils
...
if(l?(h=!1,g=k[l],delete k[l]):h=!0,k[c]=f,a._Store.setUserAttributes(b,k),!g||!Array.isArray(g))j=!0;else if(e.length!==g.length)j=!0;else for(var m=0;m<e.length;m++)if(g[m]!==e[m]){j=!0;break}j&&d.sendUserAttributeChangeEvent(c,e,g,h,!1,this),a._Forwarders.initForwarders(d.IdentityAPI.getCurrentUser().getUserIdentities(),a._APIClient.prepareForwardingStats),a._Forwarders.handleForwarderUserAttributes("setUserAttribute",c,f);}},/**
             ...
             */getCart:function getCart(){return a.Logger.warning("Deprecated function Identity.getCurrentUser().getCart() will be removed in future releases"),d.mParticleUserCart()},/**
...
function tryOnUserAlias(a,b,c,d){if(c&&c.onUserAlias&&isFunction(c.onUserAlias))try{d.warning(generateDeprecationMessage("onUserAlias")),c.onUserAlias(a,b);}catch(a){d.error("There was an error with your onUserAlias function - "+a);}}
