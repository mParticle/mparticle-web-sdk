...
function didUserChange(a,b){return !a||b.getMPID()!==a.getMPID()||a.isLoggedIn()!==b.isLoggedIn()}
...
if(p?(g=!1,o=d[p],delete d[p]):g=!0,d[r]=u,a&&a[e]&&(a[e].ua=d,t._Persistence.savePersistence(a,e)),!o||!Array.isArray(o))l=!0;else if(n.length!==o.length)l=!0;else for(var c=0;c<n.length;c++)if(o[c]!==n[c]){l=!0;break}l&&s.sendUserAttributeChangeEvent(r,n,o,g,!1,this),t._Forwarders.initForwarders(s.IdentityAPI.getCurrentUser().getUserIdentities(),t._APIClient.prepareForwardingStats),t._Forwarders.handleForwarderUserAttributes("setUserAttribute",r,u);}},/**
...
return t._Helpers.getFeatureFlag(FeatureFlags$1.AudienceAPI)?void(null===s.audienceManager&&(s.audienceManager=new AudienceManager(t._Store.SDKConfig.userAudienceUrl,t._Store.devToken,t.Logger,e)),s.audienceManager.sendGetUserAudienceRequest(e,r)):void t.Logger.error(ErrorMessages.AudienceAPINotEnabled)}}},this.mParticleUserCart=function(e){return {/**
             ...
             * @deprecated
             */getCartProducts:function getCartProducts(){return t.Logger.warning("Deprecated function Identity.getCurrentUser().getCart().getCartProducts() will be removed in future releases"),t._Persistence.getCartProducts(e)}}},this.parseIdentityResponse=function(r,i,a,d,o,g,l){var u,p,c=t.Identity.getUser(i),y=c?c.getMPID():null,_=c?c.getUserIdentities().userIdentities:{},I={};t._Store.identityCallInFlight=!1;try{var v;t.Logger.verbose("Parsing \""+o+"\" identity response from server"),u=r.responseText?JSON.parse(r.responseText):null,t._Store.isLoggedIn=(null===(v=u)||void 0===v?void 0:v.is_logged_in)||!1,t._Store.mpid=u.mpid,c&&t._Persistence.setLastSeenTime(i);var m=!t._Persistence.getFirstSeenTime(u.mpid);// https://go.mparticle.com/work/SQDSDKS-6329
if(t._Persistence.setFirstSeenTime(u.mpid),200===r.status){s(CacheIdentity)&&cacheOrClearIdCache(o,g,n.idCache,r,l);var S=n.IdentityAPI.getUser(u.mpid),P=S?S.getUserIdentities().userIdentities:{};o===Modify$1?(I=t._Identity.IdentityRequest.combineUserIdentities(_,d.userIdentities),t._Persistence.saveUserIdentitiesToPersistence(i,I)):(o===Identify&&c&&u.mpid===y&&t._Persistence.setFirstSeenTime(u.mpid),t._Store.addMpidToSessionHistory(u.mpid,i),t._CookieSyncManager.attemptCookieSync(i,u.mpid,m),t._Persistence.swapCurrentUser(i,u.mpid,t._Store.currentSessionMPIDs),d&&!isEmpty(d.userIdentities)&&(I=n.IdentityRequest.combineUserIdentities(P,d.userIdentities)),t._Persistence.saveUserIdentitiesToPersistence(u.mpid,I),t._Persistence.update(),t._Persistence.findPrevCookiesBasedOnUI(d),t._Store.context=u.context||t._Store.context),p=t.Identity.getCurrentUser(),tryOnUserAlias(c,p,d,t.Logger);var b=t._Persistence.getPersistence();p&&(t._Persistence.storeDataInMemory(b,p.getMPID()),n.reinitForwardersOnUserChange(c,p),n.setForwarderCallbacks(p,o));var A=getNewIdentitiesByName(I),U=o===Modify$1?_:P;n.sendUserIdentityChangeEvent(A,u.mpid,U);}if(a){var C=0===r.status?HTTPCodes$2.noHttpCoverage:r.status;t._Helpers.invokeCallback(a,C,u||null,p);}else u&&!isEmpty(u.errors)&&t.Logger.error("Received HTTP response code of "+r.status+" - "+u.errors[0].message);t.Logger.verbose("Successfully parsed Identity Response"),t._APIClient.processQueuedEvents();}catch(s){a&&t._Helpers.invokeCallback(a,r.status,u||null),t.Logger.error("Error parsing JSON response from Identity server: "+s);}},this.sendUserIdentityChangeEvent=function(e,r,s){// https://go.mparticle.com/work/SQDSDKS-6354
var i=this.IdentityAPI.getUser(r);for(var a in e)// Verifies a change actually happened
if(s[a]!==e[a]){// If a new identity type was introduced when the identity changes
// we need to notify the server so that it will associate the new
// identity type with subsequent events
var d=!s[a],o=n.createUserIdentityChange(a,e[a],s[a],d,i);t._APIClient.sendEventToServer(o);}},this.createUserIdentityChange=function(e,r,s,i,n){var a;return a=t._ServerModel.createEventObject({messageType:Types.MessageType.UserIdentityChange,userIdentityChanges:{New:{IdentityType:e,Identity:r,CreatedThisBatch:i},Old:{IdentityType:e,Identity:s,CreatedThisBatch:!1}},userInMemory:n}),a},this.sendUserAttributeChangeEvent=function(e,r,s,i,a,d){var o=n.createUserAttributeChange(e,r,s,i,a,d);o&&t._APIClient.sendEventToServer(o);},this.createUserAttributeChange=function(e,r,s,i,n,a){"undefined"==typeof s&&(s=null);var d;return r!==s&&(d=t._ServerModel.createEventObject({messageType:Types.MessageType.UserAttributeChange,userAttributeChanges:{UserAttributeName:e,New:r,Old:s,Deleted:n,IsNewAttribute:i}},a)),d},this.reinitForwardersOnUserChange=function(e,r){didUserChange(e,r)&&t._Forwarders.initForwarders(r.getUserIdentities().userIdentities,t._APIClient.prepareForwardingStats);},this.setForwarderCallbacks=function(e,r){// https://go.mparticle.com/work/SQDSDKS-6036
t._Forwarders.setForwarderUserIdentities(e.getUserIdentities().userIdentities),t._Forwarders.setForwarderOnIdentityComplete(e,r),t._Forwarders.setForwarderOnUserIdentified(e);};}// https://go.mparticle.com/work/SQDSDKS-6359
