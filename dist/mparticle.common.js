...
function completeSDKInitialization(a,b,c){var d,e=createKitBlocker(b,c),f=c._Helpers.getFeatureFlag;// Web View Bridge is used for cases where the Web SDK is loaded within an iOS or Android device's
...
if(c._APIClient=new APIClient(c,e),c._Forwarders=new Forwarders(c,e),c._Store.processConfig(b),c._Identity.idCache=createIdentityCache(c),removeExpiredIdentityCacheDates(c._Identity.idCache),c._Store.webviewBridgeEnabled)c._NativeSdkHelpers.initializeSessionAttributes(a);else {c._Persistence.initializeStorage(),c._Store.syncPersistenceData();// Set up user identitiy variables for later use
var g=c.Identity.getCurrentUser(),h=g?g.getMPID():null,i=g?g.getUserIdentities().userIdentities:{};c._Store.SDKConfig.identifyRequest=c._Store.hasInvalidIdentifyRequest()?{userIdentities:i}:c._Store.SDKConfig.identifyRequest,f(ReportBatching)&&c._ForwardingStatsUploader.startForwardingStatsTimer();// https://go.mparticle.com/work/SQDSDKS-7639
var j=f(CaptureIntegrationSpecificIds),k=f(CaptureIntegrationSpecificIdsV2),l=k&&k!==CaptureIntegrationSpecificIdsV2Modes.None||!0===j;if(l){var m;j||k===CaptureIntegrationSpecificIdsV2Modes.All?m="all":k===CaptureIntegrationSpecificIdsV2Modes.RoktOnly&&(m="roktonly"),c._IntegrationCapture=new IntegrationCapture(m),c._IntegrationCapture.capture();}// Configure Rokt Manager with user and filtered user
var n=parseConfig(b,"Rokt",181);if(n){var o=null===(d=n.settings)||void 0===d?void 0:d.accountId;c._Store.setRoktAccountId(o);var p=n.userAttributeFilters,q=filteredMparticleUser(h,{userAttributeFilters:p},c),r={sandbox:null===b||void 0===b?void 0:b.isDevelopmentMode,launcherOptions:null===b||void 0===b?void 0:b.launcherOptions,domain:null===b||void 0===b?void 0:b.domain};// https://go.mparticle.com/work/SQDSDKS-7339
c._RoktManager.init(n,q,c.Identity,c._Store,c.Logger,r,c.captureTiming);}c._Forwarders.processForwarders(b,c._APIClient.prepareForwardingStats),c._Forwarders.processPixelConfigs(b),c._SessionManager.initialize(),c._Events.logAST(),processIdentityCallback(c,g,h,i);}// We will continue to clear out the ready queue as part of the initial init flow
