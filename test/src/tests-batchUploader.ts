...
describe('batch uploader', () => {
    ...
    describe('Offline Storage Enabled', () => {
        ...
        it.skip('should save batches in sequence to Local Storage when upload is interrupted', async () => {
            ...
            expect(
                (storedBatches[2].events[0].data as CustomEventData).event_name,
                'Batch 2: Test Event 5 Event Name',
            ).to.equal('Test Event 5');
            expect(
                (storedBatches[2].events[1].data as CustomEventData).event_name,
        ...
        it.skip('should attempt to upload batches from Offline Storage before new batches', async () => {
            ...
            expect(
                (uploadedBatch1.events[0].data as CustomEventData).event_name,
                'Batch 1: Test Event 1 ',
            ).to.equal('Test Event 1');
            expect(
                (uploadedBatch1.events[1].data as CustomEventData).event_name,
                'Batch 1: Test Event 2',
            ).to.equal('Test Event 2');
