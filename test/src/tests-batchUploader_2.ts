...
describe.skip('batch uploader', () => {
    ...
    describe('Upload Workflow', () => {
        ...
        it.skip('should keep batches in sequence for future retries when an HTTP 500 error occurs', async () => {
        ...
        // TODO: Investigate workflow with unshift vs push
        // https://go.mparticle.com/work/SQDSDKS-5165
        it.skip('should keep and retry batches in sequence if the transmission fails midway', async () => {
