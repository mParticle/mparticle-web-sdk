...
describe('identity', function () {
    ...
    describe('requests', function () {
        it('should contain identify request', async () => {
            ...
            const data = JSON.parse(
                firstCall[1].body as unknown as string,
        ...
        it('should contain logout request', async () => {
            ...
            const data: IIdentityAPIRequestData = JSON.parse(
        ...
        it('should contain login request', async () => {
            ...
            const data: IIdentityAPIRequestData = JSON.parse(
                loginCall[1].body as unknown as string,
            );
        ...
        it('should contain modify request', async () => {
            ...
            const data: IIdentityAPIModifyRequestData = JSON.parse(
                lastCall[1].body as unknown as string,
            );
    ...
    describe('cookies', function () {
        ...
        it('localStorage - should switch user cookies to new mpid details from cookies when a new mpid is provided', async () => {
            ...
            expect(cookiesAfterMPIDChange).to.have.property(
                'cu',
                'logged-in-user',
            );
            ...
            props.forEach(function (prop) {
                expect(cookiesAfterMPIDChange[testMPID]).to.not.have.property(
                    prop,
                );
                expect(
                    cookiesAfterMPIDChange['logged-in-user'],
        ...
        it('cookies - should switch user cookies to new mpid details from cookies when a new mpid is provided', async () => {
            ...
            props2.forEach(function (prop) {
                ...
                cookiesAfterMPIDChange[
                    'logged-in-user'
                ].should.not.have.property(prop);
            });
        });
    });
    ...
    describe('identity request validation', function () {
        it('should swap property identityType for identityName', function (done) {
            ...
            for (const key in data.userIdentities) {
                ...
                expect(mParticle.IdentityType.getIdentityType(key)).to.equal(
                    count,
                );
                count++;
        ...
        it('should create a proper identity request', async (done) => {
            ...
            expect(identityRequest.known_identities.mobile_number).to.equal(
                'id19',
            );
        ...
        it('should create a proper modify identity request', async (done) => {
            ...
            expect(identityRequest.identity_changes[1].old_value).to.equal(
                'id2',
            );
            ...
            expect(identityRequest.identity_changes[2].old_value).to.equal(
                'id3',
            );
            expect(identityRequest.identity_changes[2].identity_type).to.equal(
                'facebook',
            );
            expect(identityRequest.identity_changes[2].new_value).to.equal(
                'id16',
            );
            ...
            expect(identityRequest.identity_changes[3].old_value).to.equal(
                'id4',
            );
            expect(identityRequest.identity_changes[3].identity_type).to.equal(
                'twitter',
            );
            expect(identityRequest.identity_changes[3].new_value).to.equal(
                'id17',
            );
            ...
            expect(identityRequest.identity_changes[4].old_value).to.equal(
                'id5',
            );
            expect(identityRequest.identity_changes[4].identity_type).to.equal(
                'google',
            );
            expect(identityRequest.identity_changes[4].new_value).to.equal(
                'id18',
            );
            ...
            expect(identityRequest.identity_changes[5].old_value).to.equal(
                'id6',
            );
            expect(identityRequest.identity_changes[5].identity_type).to.equal(
                'microsoft',
            );
            expect(identityRequest.identity_changes[5].new_value).to.equal(
                'id19',
            );
            ...
            expect(identityRequest.identity_changes[6].old_value).to.equal(
                'id7',
            );
            expect(identityRequest.identity_changes[6].identity_type).to.equal(
                'yahoo',
            );
            expect(identityRequest.identity_changes[6].new_value).to.equal(
                'id20',
            );
            ...
            expect(identityRequest.identity_changes[7].old_value).to.equal(
                'id8',
            );
            expect(identityRequest.identity_changes[7].identity_type).to.equal(
                'email',
            );
            expect(identityRequest.identity_changes[7].new_value).to.equal(
                'id21',
            );
            ...
            expect(identityRequest.identity_changes[8].old_value).to.equal(
                'id9',
            );
            expect(identityRequest.identity_changes[8].identity_type).to.equal(
                'facebookcustomaudienceid',
            );
            expect(identityRequest.identity_changes[8].new_value).to.equal(
                'id22',
            );
            ...
            expect(identityRequest.identity_changes[9].old_value).to.equal(
                'id11',
            );
            expect(identityRequest.identity_changes[9].identity_type).to.equal(
                'other2',
            );
            expect(identityRequest.identity_changes[9].new_value).to.equal(
                'id23',
            );
            ...
            expect(identityRequest.identity_changes[10].old_value).to.equal(
                'id12',
            );
            expect(identityRequest.identity_changes[10].identity_type).to.equal(
                'other3',
            );
            expect(identityRequest.identity_changes[10].new_value).to.equal(
                'id24',
            );
            ...
            expect(identityRequest.identity_changes[11].old_value).to.equal(
                'id13',
            );
            expect(identityRequest.identity_changes[11].identity_type).to.equal(
                'other4',
            );
            expect(identityRequest.identity_changes[11].new_value).to.equal(
                'id25',
            );
            ...
            expect(identityRequest.identity_changes[12].old_value).to.equal(
                'id14',
            );
            expect(identityRequest.identity_changes[12].identity_type).to.equal(
                'other5',
            );
            expect(identityRequest.identity_changes[12].new_value).to.equal(
                'id26',
            );

            expect(identityRequest.identity_changes[13].old_value).to.equal(
                'id15',
            );
            expect(identityRequest.identity_changes[13].identity_type).to.equal(
                'other6',
            );
            expect(identityRequest.identity_changes[13].new_value).to.equal(
                'id27',
            );

            expect(identityRequest.identity_changes[14].old_value).to.equal(
                'id16',
            );
            expect(identityRequest.identity_changes[14].identity_type).to.equal(
                'other7',
            );
            expect(identityRequest.identity_changes[14].new_value).to.equal(
                'id28',
            );

            expect(identityRequest.identity_changes[15].old_value).to.equal(
                'id17',
            );
            expect(identityRequest.identity_changes[15].identity_type).to.equal(
                'other8',
            );
            expect(identityRequest.identity_changes[15].new_value).to.equal(
                'id29',
            );

            expect(identityRequest.identity_changes[16].old_value).to.equal(
                'id18',
            );
            expect(identityRequest.identity_changes[16].identity_type).to.equal(
                'other9',
            );
            expect(identityRequest.identity_changes[16].new_value).to.equal(
                'id30',
            );

            expect(identityRequest.identity_changes[17].old_value).to.equal(
                'id19',
            );
            expect(identityRequest.identity_changes[17].identity_type).to.equal(
                'other10',
            );
            expect(identityRequest.identity_changes[17].new_value).to.equal(
                'id31',
            );

            expect(identityRequest.identity_changes[18].old_value).to.equal(
                'id20',
            );
            expect(identityRequest.identity_changes[18].identity_type).to.equal(
                'mobile_number',
            );
            expect(identityRequest.identity_changes[18].new_value).to.equal(
                'id32',
            );

            expect(identityRequest.identity_changes[19].old_value).to.equal(
                'id21',
            );
            expect(identityRequest.identity_changes[19].identity_type).to.equal(
                'phone_number_2',
            );
            expect(identityRequest.identity_changes[19].new_value).to.equal(
                'id33',
            );

            expect(identityRequest.identity_changes[20].old_value).to.equal(
                'id22',
            );
            expect(identityRequest.identity_changes[20].identity_type).to.equal(
                'phone_number_3',
            );
            expect(identityRequest.identity_changes[20].new_value).to.equal(
                'id34',
            );
    ...
    it('getUsers should return all mpids available in local storage', async () => {
        ...
        await waitForCondition(
            () => mParticle.Identity?.getUsers().length === 4,
        );
    ...
    it("should find the related MPID's cookies when given a UI with fewer IDs when passed to login, logout, and identify, and then log events with updated cookies", async () => {
        ...
        const testEvent1Batch = JSON.parse(
            fetchMock.calls()[7][1].body as string,
        );
        ...
        const testEvent2Batch = JSON.parse(
            fetchMock.calls()[10][1].body as string,
        );
        ...
        const testEvent3Batch = JSON.parse(
            fetchMock.calls()[12][1].body as string,
        );
    ...
    it('should have no user identities when logging out or in with no object', async () => {
        ...
        expect(userIdentities1.userIdentities).to.deep.equal({
            customerid: '123',
        });
                        ...
                        .then(() => {
                            ...
                            waitForCondition(hasIdentityCallInflightReturned)
                                .then(() => {
                                    ...
                                    expect(fetchMock.lastCall()[0]).to.equal(
                                        urls.events,
                                    );
                        ...
                        .then(() => {
                            ...
                            const user2 = {
                                ...
                                onUserAlias: function (user1, user2) {
                                    const user1Attributes =
                                        user1.getAllUserAttributes();
                                    for (const key in user1Attributes) {
                                        if (key !== 'gender') {
                                            user2.setUserAttribute(
                                                key,
                                                user1Attributes[key],
                                            );
                                        }
                                    }
                                    user2.setUserAttributeList(
                                        'list',
                                        [1, 2, 3, 4, 5],
                                    );
                            ...
                            waitForCondition(
                                ...
                                .then(() => {
                                    const user1ObjectAttrs =
                                        user1Object.getAllUserAttributes();
                                    user1ObjectAttrs.should.not.have.property(
                                        'age',
                                    );
                                    user1ObjectAttrs.should.have.property(
                                        'gender',
                                        'male',
                                    );
                                    ...
                                    const user2Attrs =
                                        mParticle.Identity.getCurrentUser().getAllUserAttributes();
                                    user2Attrs.should.not.have.property(
                                        'gender',
                                    );
                                    user2Attrs.should.have.property('age', 27);
                                    const user2ObjectAttrs =
                                        user2Object.getAllUserAttributes();
                                    user2ObjectAttrs.should.not.have.property(
                                        'gender',
                                    );
                                    user2ObjectAttrs.should.have.property(
                                        'age',
                                        27,
                                    );
    ...
    it('should still trigger the identifyCallback when no identify request is sent because there are already cookies', async () => {
        ...
        expect(eventData.events[0].event_type).to.equal(
            'application_state_transition',
        );
    ...
    describe('identityCallback responses', function () {
        ...
        it('should have a getUser function on login result object', async () => {
            ...
            const identityRequest = {
                userIdentities: { customerid: 'test123' },
            };
    ...
    it('Users should have firstSeenTime and lastSeenTime', async () => {
        ...
        expect(currentUser.getFirstSeenTime(), 'First Seen Time').to.lessThan(
            now.getTime(),
        );
        expect(currentUser.getLastSeenTime(), 'Last Seen Time').to.equal(
            now.getTime(),
        );
    ...
    it('firstSeenTime should stay the same for a user', async () => {
        ...
        expect(currentUser.getFirstSeenTime()).to.greaterThanOrEqual(
            user1LastSeen,
        );

        // We should expect the FirstSeenTime to be between the time the test started
        // the logged in request completed
        expect(currentUser.getFirstSeenTime()).to.greaterThan(
            nowTestStart.getTime(),
        );
        expect(currentUser.getFirstSeenTime()).to.lessThan(
            nowAfterLogin.getTime(),
        );
    ...
    it('should return the correct user for Previous User', async () => {
        ...
        await waitForCondition(
            () => mParticle.Identity.getCurrentUser()?.getMPID() === '1',
        );
    ...
    describe('custom device', function () {
        ...
        it('should use the custom device id in known_identities when passed via setDeviceId', async () => {
            ...
            expect(data.known_identities).to.have.keys(
                'device_application_stamp',
            );
            expect(
                data.known_identities.device_application_stamp.length,
            ).to.equal(36);
            ...
            const data2 = JSON.parse(
                nextCall[1].body as unknown as string,
            ) as IIdentityAPIRequestData;
            expect(data2.known_identities.device_application_stamp).to.equal(
                'foo-guid',
            );
        });
        ...
        it('should use the custom device id in known_identities when set via mParticle.config', async (done) => {
            ...
            expect(data.known_identities.device_application_stamp).to.equal(
                'foo-guid',
            );
    ...
    describe('identity caching', function () {
        ...
        it('should use header `x-mp-max-age` as expiration date for cache', async () => {
            ...
            for (const key in idCache) {
                ...
                // of the max age
                expect(idCache[key].expireTimestamp).to.greaterThan(
    ...
    describe('Rokt Manager', function () {
        ...
        it('should set currentUser once the email is positively identified', async () => {
            ...
            await waitForCondition(() =>
                hasIdentifyReturnedWithEmail(testRoktEmail),
            );

            expect(mpInstance._RoktManager['currentUser']).to.not.be.null;
            expect(
                mpInstance._RoktManager['currentUser'].getUserIdentities()
                    .userIdentities.email,
            ).to.equal(testRoktEmail);
        });
