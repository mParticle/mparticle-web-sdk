...
describe('persistence', () => {
    ...
    it('puts data into cookies when updating persistence with useCookieStorage = true', async () => {
        ...
        const cookieData: Partial<IPersistenceMinified> = findCookie();
        expect(cookieData).to.include.keys('gs', 'cu', testMPID);
        const localStorageData: Partial<IPersistenceMinified> = mParticle.getInstance()._Persistence.getLocalStorage();
    ...
    it('puts data into localStorage when updating persistence with useCookieStorage = false', async () => {
        ...
        const localStorageData: Partial<IPersistenceMinified> = getLocalStorage();
        const cookieData: Partial<IPersistenceMinified> = findCookie();
