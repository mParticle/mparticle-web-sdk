...
describe('forwarders', function() {
    beforeEach(function() {
        ...
        fetchMockSuccess(urls.forwarding, {
            mpid: testMPID,
            is_logged_in: false,
        });
        ...
        waitForCondition(hasIdentifyReturned).then(() => {
            ...
            waitForCondition(() => {
                ...
                waitForCondition(() => {
                    ...
                    mParticle.userIdentitiesFilterOnInitTest.length.should.equal(
                        2,
                    );
                    mParticle.userIdentitiesFilterOnInitTest[0].Type.should.equal(
                        1,
                    );
                    mParticle.userIdentitiesFilterOnInitTest[0].Identity.should.equal(
                        '123',
                    );
                    mParticle.userIdentitiesFilterOnInitTest[1].Type.should.equal(
                        7,
                    );
                    ...
                    Should(
                        mParticle.userIdentitiesFilterOnInitTest[2],
                    ).not.be.ok();
    ...
    it('should pass filteredUser and filteredUserIdentities to onIdentifyComplete methods', function(done) {
        ...
        waitForCondition(() => {
            ...
            waitForCondition(() => {
                ...
                expect(
                    window.MockForwarder1.instance.onIdentifyCompleteCalled,
                ).to.eq(true);
                expect(window.MockForwarder1.instance.onIdentifyCompleteUser).to
                    .be.ok;
                expect(
    ...
    it('should pass filteredUser and filteredUserIdentities to onLoginComplete methods', function(done) {
        ...
        waitForCondition(() => {
            ...
            waitForCondition(() => {
                ...
                expect(
                    window.MockForwarder1.instance.onLoginCompleteCalled,
                ).to.eq(true);
                expect(window.MockForwarder1.instance.onLoginCompleteUser).to.be
                    .ok;
                expect(
                    window.MockForwarder1.instance
                        .onLoginCompleteFilteredUserIdentities,
                ).to.deep.equal({
                    userIdentities: {
                        // Filtered Identity should no longer have `google` as an identity
                        email: 'test@gmail.com',
    ...
    it('should pass filteredUser and filteredUserIdentities to onLogoutComplete methods', function(done) {
        ...
        waitForCondition(() => {
            ...
            waitForCondition(() => {
                ...
                expect(
                    window.MockForwarder1.instance.onLogoutCompleteCalled,
                ).to.eq(true);
                expect(window.MockForwarder1.instance.onLogoutCompleteUser).to
                    .be.ok;
                expect(
                    window.MockForwarder1.instance
    ...
    it('should pass filteredUser and filteredUserIdentities to onModifyComplete methods', function(done) {
        ...
        waitForCondition(() => {
            ...
            waitForCondition(() => {
                ...
                expect(
                    window.MockForwarder1.instance.onModifyCompleteCalled,
                ).to.eq(true);
                expect(window.MockForwarder1.instance.onModifyCompleteUser).to
                    .be.ok;
                expect(
                    window.MockForwarder1.instance
    ...
    it('parse and capture forwarderConfiguration properly from backend', function(done) {
        ...
        waitForCondition(() => {
            return (
                window.mParticle.getInstance()._Store.configurationLoaded ===
                    true &&
                window.mParticle.getInstance()?._Store?.identityCallInFlight ===
                    false
            );
        ...
        describe('initialization', function() {
            ...
            it('should NOT add a flag in batches for reporting if sideloaded kits are not used', function() {
                ...
                waitForCondition(() => {
                    ...
                    expect(mpInstance._Store.isUsingSideloadedKits).to.be
                        .undefined;
        ...
        describe('forwarding', function() {
            ...
            it('should send event to sideloaded kits', function() {
                ...
                waitForCondition(() => {
                    ...
                    sideloadedKit1Event.should.have.property(
                        'EventName',
                        'foo',
                    );
                    sideloadedKit2Event.should.have.property(
                        'EventName',
                        'foo',
                    );
                });
