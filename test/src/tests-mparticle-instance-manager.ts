...
describe('mParticle instance manager', () => {
    ...
    describe('multiple instances testing', () => {
        ...
        it('logs purchase events to their own instances', async () => {
            ...
            mParticle.getInstance().eCommerce.logPurchase(ta, [product1, product2]);
            ...
            mParticle.getInstance('instance2').eCommerce.logPurchase(ta, [product1, product2]);
            ...
            mParticle.getInstance('instance3').eCommerce.logPurchase(ta, [product1, product2]);
