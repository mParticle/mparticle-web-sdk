...
describe('Utils', () => {
    ...
    describe('queryStringParser', () => {
        ...
        describe('without URLSearchParams', () => {
            ...
            it('should handle non-standard characters or malformed urls', () => {
                ...
                const keys = ['foo', 'narf', 'param0', 'param1', 'param2', 'param3', 'param4'];
    ...
    describe('#createCookieSyncUrl', () => {
        ...
        it('should add domain parameter when provided', () => {
            ...
            expect(createCookieSyncUrl('testMPID', simplePixelUrl, null, 'example.com')).toBe(
                'https://test.com/pixel?domain=example.com',
            );
        });

        it('should handle domain parameter with hyphens and dots', () => {
            const simplePixelUrl = 'https://test.com/pixel';
            expect(createCookieSyncUrl('testMPID', simplePixelUrl, null, 'sub-domain.example.com')).toBe(
                'https://test.com/pixel?domain=sub-domain.example.com',
            );
        });
        ...
        it('should handle domain parameter with redirect URL', () => {
            ...
            expect(createCookieSyncUrl('testMPID', simplePixelUrl, simpleRedirectUrl, 'example.com')).toBe(
                'https://test.com/pixelhttps%3A%2F%2Fredirect.com%2Fcallback?domain=example.com',
            );
        });
    ...
    describe('#toWebSafeBase64', () => {
        it('should strip base64 padding', () => {
            ...
            expect(toWebSafeBase64('-1234567890123456789')).toBe('LTEyMzQ1Njc4OTAxMjM0NTY3ODk');
        });
            ...
            it('should handle objects with arrays of nested objects', () => {
                const input = {
                    users: [
                        ...
                        {
                            name: 'Jane',
                            contacts: [{ type: 'email', value: 'jane@email.com' }],
                        },
                    ],
                };
