/**
 * Legacy DefinitelyTyped compatibility compile test.
 *
 * This file is based on the old @types/mparticle__web-sdk instance tests. It
 * keeps the old mParticle namespace-style type references while importing the
 * SDK through this package's default runtime export.
 */
...
declare namespace mParticle {
    export type AllUserAttributes = MParticleTypes.AllUserAttributes;
    export type CCPAConsentState = MParticleTypes.CCPAConsentState;
    export type ConsentState = MParticleTypes.ConsentState;
    export type DataPlanConfig = MParticleTypes.DataPlanConfig;
    export type GDPRConsentState = MParticleTypes.GDPRConsentState;
    export type IdentifyRequest = MParticleTypes.IdentifyRequest;
    export type IdentityCallback = MParticleTypes.IdentityCallback;
    export type IdentityResult = MParticleTypes.IdentityResult;
    export type IdentityResultBody = MParticleTypes.IdentityResultBody;
    export type Impression = MParticleTypes.Impression;
    export type KitFilterSettings = MParticleTypes.KitFilterSettings;
    export type Location = MParticleTypes.Location;
    export type Logger = MParticleTypes.Logger;
    export type MPConfiguration = MParticleTypes.MPConfiguration;
    export type MPForwarder = MParticleTypes.MPForwarder;
    export type MPID = MParticleTypes.MPID;
    export type MPSideloadedKit = MParticleTypes.MPSideloadedKit;
    export type Product = MParticleTypes.Product;
    export type Promotion = MParticleTypes.Promotion;
    export type RoktAttributes = MParticleTypes.RoktAttributes;
    export type RoktPlacement = MParticleTypes.RoktPlacement;
    export type RoktPlacementEvent<T = unknown> =
        MParticleTypes.RoktPlacementEvent<T>;
    export type RoktSelection = MParticleTypes.RoktSelection;
    export type SDKEventAttrs = MParticleTypes.SDKEventAttrs;
    export type SDKEventCustomFlags = MParticleTypes.SDKEventCustomFlags;
    export type SDKEventOptions = MParticleTypes.SDKEventOptions;
    export type TransactionAttributes = MParticleTypes.TransactionAttributes;
    export type User = MParticleTypes.User;
    export type UserAliasRequest = MParticleTypes.UserAliasRequest;
    export type onCreateBatch = MParticleTypes.onCreateBatch;
}
...
const identities: mParticle.IdentifyRequest = mParticle.Identity.getCurrentUser().getUserIdentities();
...
mParticle.Rokt.hashAttributes({
    ...
    userId: "12345",
    segment: "premium",
}).then((hashedAttrs: mParticle.RoktAttributes) => {
