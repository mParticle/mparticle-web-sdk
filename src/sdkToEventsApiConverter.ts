...
export function getMessageTypeFromEventType(
    ...
    switch (eventType) {
        case 'custom_event':
            return Types.MessageType.PageEvent;
        case 'screen_view':
            return Types.MessageType.PageView;
        case 'commerce_event':
            return Types.MessageType.Commerce;
        case 'session_start':
            return Types.MessageType.SessionStart;
        case 'session_end':
            return Types.MessageType.SessionEnd;
        case 'crash_report':
            return Types.MessageType.CrashReport;
        case 'opt_out':
            return Types.MessageType.OptOut;
        case 'application_state_transition':
            return Types.MessageType.AppStateTransition;
        case 'user_attribute_change':
            return Types.MessageType.UserAttributeChange;
        case 'user_identity_change':
            return Types.MessageType.UserIdentityChange;
        default:
            return -1;
    }
}
...
export function getEventCategoryFromCustomEventType(
    ...
    switch (customEventType) {
        case 'navigation':
            return Types.EventType.Navigation;
        case 'location':
            return Types.EventType.Location;
        case 'search':
            return Types.EventType.Search;
        case 'transaction':
            return Types.EventType.Transaction;
        case 'user_content':
            return Types.EventType.UserContent;
        case 'user_preference':
            return Types.EventType.UserPreference;
        case 'social':
            return Types.EventType.Social;
        case 'other':
            return Types.EventType.Other;
        case 'media':
            return Types.EventType.Media;
        case 'add_to_cart':
...
export function getIdentityTypeFromBatchKey(
    ...
    switch (key) {
        case 'other':
            return Types.IdentityType.Other;
        case 'customer_id':
            return Types.IdentityType.CustomerId;
        case 'facebook':
            return Types.IdentityType.Facebook;
        case 'twitter':
            return Types.IdentityType.Twitter;
        case 'google':
            return Types.IdentityType.Google;
        case 'microsoft':
            return Types.IdentityType.Microsoft;
        case 'yahoo':
            return Types.IdentityType.Yahoo;
        case 'email':
            return Types.IdentityType.Email;
        case 'facebook_custom_audience_id':
            return Types.IdentityType.FacebookCustomAudienceId;
        case 'other_id_2':
            return Types.IdentityType.Other2;
        case 'other_id_3':
            return Types.IdentityType.Other3;
        case 'other_id_4':
            return Types.IdentityType.Other4;
        case 'other_id_5':
            return Types.IdentityType.Other5;
        case 'other_id_6':
            return Types.IdentityType.Other6;
        case 'other_id_7':
            return Types.IdentityType.Other7;
        case 'other_id_8':
            return Types.IdentityType.Other8;
        case 'other_id_9':
            return Types.IdentityType.Other9;
        case 'other_id_10':
            return Types.IdentityType.Other10;
        case 'mobile_number':
            return Types.IdentityType.MobileNumber;
        case 'phone_number_2':
            return Types.IdentityType.PhoneNumber2;
        case 'phone_number_3':
            return Types.IdentityType.PhoneNumber3;
        default:
            return -1;
    }
}
