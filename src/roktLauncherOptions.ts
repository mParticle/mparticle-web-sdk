...
export function normalizeRoktLauncherOptions(launcherOptions?: IRoktLauncherOptions): IRoktLauncherOptions {
    const normalizedOptions = launcherOptions ? { ...launcherOptions } : {};
    const hasNoDeviceId = normalizedOptions.noDeviceId === true || normalizedOptions.noDeviceID === true;
