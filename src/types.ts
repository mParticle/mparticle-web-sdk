// TODO: Ideally all types should use this object
// class OptionType<T extends number | string | boolean = string> {
//     public key: T;
//     public displayName: string;
//     public description: string;

//     constructor(key: T, displayName?: string, description?: string) {
//         this.key = key;
...
const EventType = {
    ...
    // TODO: Refactor so that new objects have a key and displayName property instead of
    //       an event lookup
    getName: getEventTypeName,
};
